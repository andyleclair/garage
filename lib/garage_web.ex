defmodule GarageWeb do
  ...
  def static_paths, do: ~w(uploads assets js fonts images favicon.ico robots.txt)
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: GarageWeb.Router,
        statics: GarageWeb.static_paths()
    end
  end
