# defmodule TreatsCarburetorSpider do
#  use Crawly.Spider
#
#  @impl Crawly.Spider
...
#  @impl Crawly.Spider
#  def init() do
#    [start_urls: ["https://www.treatland.tv/category-s/95.htm"]]
#  end
#
#  @impl Crawly.Spider
#  @doc """
...
#
#        [num] ->
#          "https://www.treatland.tv/category-s/95.htm?searching=Y&sort=5&cat=95&show=50&page=#{num}"
#      end
#      |> List.wrap()
