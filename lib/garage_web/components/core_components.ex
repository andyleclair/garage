defmodule GarageWeb.CoreComponents do
  @moduledoc """
  ...
  See also: https://hexdocs.pm/live_select/cheatsheet.html
  """
  def live_select(%{field: %Phoenix.HTML.FormField{} = field} = assigns) do
    ...
    <div phx-feedback-for={@field.name}>
      ...
      >
        <:clear_button>
          <div
            class="inline-flex items-center p-1 ms-2 mb-0.5 text-sm text-gray-400 bg-transparent rounded-xs hover:bg-gray-200 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-gray-300"
            aria-label="Remove"
          >
            <svg
              class="w-2 h-2"
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GarageWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GarageWeb.Gettext, "errors", msg, opts)
    end
  end
